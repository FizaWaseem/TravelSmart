...
export default function BusTable() {
  ...
  const { TblContainer, TblHead, TblPagination, recordsAfterPagingAndSorting,checked,setChecked } =
      ...
      <TblContainer>
        ...
        <TableBody>
          {recordsAfterPagingAndSorting().map((item) => (
            <>
            <TableRow key={item.id} ref={btnRef} onMouseOver={() => handle(item.id)}
            onMouseOut={() => handleOut(item.id)}>
              ...
              <TableCell>
                <Grid>
                  ...
                  >
                 <Typography style={{marginTop:".3rem",fontSize:"14px",width:"50px",textDecoration:"underline", textDecorationColor:"#ff7f47"}}>Pickups</Typography>
                  </HtmlTooltip>
                </Grid>
              </TableCell>
              <TableCell>
                ...
                <Grid>
                  ...
                  >
                    <Typography style={{marginTop:".3rem",fontSize:"14px",width:"50px",textDecoration:"underline", textDecorationColor:"#ff7f47"}}>Dropoffs</Typography>
                  </HtmlTooltip>
